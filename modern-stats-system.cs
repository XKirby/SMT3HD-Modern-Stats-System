...
[assembly: MelonInfo(typeof(ModernStatsSystem.ModernStatsSystem), "Modern Stats System", "2.0.0", "X Kirby")]
            ...
            private static void Postfix()
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    for (int k = 0; k < 2; k++)
                    {
                        ...
                        { g2.GetComponent<CounterCtrBattle>().Set(PartyStats[k], Color.white, 3); }
